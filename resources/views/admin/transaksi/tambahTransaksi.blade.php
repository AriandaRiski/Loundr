...
clearInterval(interval);}
  ...
  <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Tanggal Pengambilan</label>
                    <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                        <input type="text"  name="tgl_ambil" id="date" class="form-control datetimepicker-input" data-target="#reservationdate1" placeholder="tahun - bulan - tanggal" />
    ...
    <div class="form-group">
        ...
        <input type="text" name="price" onFocus="startCalc();" onBlur="stopCalc();" readonly/>
        <label for="price">ID</label>
        <input type="text" name="id_produk" readonly/>
    </div>
